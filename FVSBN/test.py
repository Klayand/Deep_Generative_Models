...
if __name__ == "__main__":
    ...
    # Define datapoints for each class. class X sample_nums X dimensions
    inps = torch.stack([
    ...
    axs[1].set_ylabel('y')
    axs[1].set_zlabel('z')
    axs[1].scatter(inps_flattened[:, 0], inps_flattened[:, 1], inps_flattened[:, 2], c=predicted_classes.numpy(),
                   cmap='Set1')
